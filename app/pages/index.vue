              ...
              <div class="px-8 text-center flex flex-col items-center">
                ...
                <template v-if="currentView === 'month'">
                  <template v-if="monthlyBudgetLimit > 0">
                    ...
                    <p
                      class="text-xs text-primary-100/90 dark:text-neutral-400 mt-1"
                    >
                      remaining of
                      {{ formatCurrency(monthlyBudgetLimit) }} monthly limit
                    </p>
                  </template>
                  <template v-else>
                    <h2
                ...
                <template v-else>
                  <template v-if="weeklyBudgetLimit > 0">
                    ...
                    >
                      remaining of
                      {{ formatCurrency(weeklyBudgetLimit) }} weekly limit
                      (est.)
                    </p>
                  </template>
                  <template v-else>
                ...
                <div
                  v-if="
                    (currentView === 'month' && monthlyBudgetLimit > 0) ||
                    (currentView === 'week' && weeklyBudgetLimit > 0)
                  "
